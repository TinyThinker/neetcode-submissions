...
class Solution:
    ...
    def copyRandomList(self, head: 'Optional[Node]') -> 'Optional[Node]':
        ...
        self.old_to_new[head] = new_node

        next_copy = self.copyRandomList(head.next)

        new_node.random = self.old_to_new[head.random]
        new_node.next = next_copy
